...
var Step4 = function Step4(_ref) {
  ...
  var _useState3 = (0, _react.useState)(formData.designDescription || ""),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            totalSize = files.reduce(function (acc, file) {
            ...
            alert("Total size of all files should not exceed ".concat(MAX_SIZE_MB, " MB."));
          ...
          case 5:
            ...
            alert("You can upload a maximum of ".concat(MAX_IMAGES, " images."));
            return _context2.abrupt("return");
          case 8:
            newUploadingFiles = files.map(function (file) {
              return {
                name: file.name,
                status: 'uploading',
                progress: 0,
  ...
  var readFileWithProgress = function readFileWithProgress(file, progressCallback) {
  ...
  var deleteFile = function deleteFile(index) {
    var fromFormData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    if (fromFormData) {
      var newFiles = _toConsumableArray(formData.referenceImages);
      ...
      var _newFiles = _toConsumableArray(uploadingFiles);
      _newFiles.splice(index, 1);
      setUploadingFiles(_newFiles);

      // Update formData to match the current uploadingFiles state
      setFormData(function (prevData) {
        return _objectSpread(_objectSpread({}, prevData), {}, {
          referenceImages: _newFiles
        });
      });
    }
  };
  ...
  }, "UPLOAD REFERENCE IMAGES (up to ", MAX_IMAGES, " images, ", MAX_SIZE_MB, " MB max)"), /*#__PURE__*/_react["default"].createElement("button", {
    className: "step4-upload-btn",
    type: "button",
    onClick: function onClick() {
  ...
  }, "Let us know about additional info of the design you want.")));
};
var _default = exports["default"] = Step4;