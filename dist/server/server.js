...
app.get('/debug/files', function (req, res) {
  ...
  try {
    var publicFiles = fs.existsSync(publicPath) ? fs.readdirSync(publicPath) : 'public dir not found';
    var cssFiles = fs.existsSync(cssPath) ? fs.readdirSync(cssPath) : 'css dir not found';
    res.json({
